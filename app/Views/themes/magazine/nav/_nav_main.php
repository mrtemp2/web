...
<div class="navbar navbar-expand-md nav-main">
    <div class="container-xl d-flex justify-content-center align-items-center" style="height: 100px;">
        <a href="<?= langBaseUrl(); ?>" class="navbar-brand p-0">
            <img src="<?= $darkMode == 1 ? getLogoFooter() : getLogo(); ?>" alt="logo" class="logo" style="max-height: 90px;">
        </a>
    </div>
