...
$postImage = getPostImage($post, 'default'); ?>
<div class="btn-share">
...
<div class="btn-share">
    <a href="javascript:void(0)" onclick="window.open('http://pinterest.com/pin/create/button/?url=<?= $postURL; ?>&amp;media=<?= $postImage; ?>', 'Share This Post', 'width=640,height=450');return false" class="color-pinterest"><i class="icon-pinterest"></i></a>
</div>
