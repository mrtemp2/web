<div class="post-item<?= checkPostImg($post, 'class'); ?>">
    ...
    <?php endif; ?>
    <h3 class="title"><a href="<?= generatePostURL($post); ?>"<?php postURLNewTab($this, $post); ?>><?= esc(characterLimiter($post->title, POST_DISPLAY_TITLE_LIMIT, '...')); ?></a></h3>
    <p class="post-meta"><?= loadView("post/_post_meta", ["post" => $post]); ?></p>
    <p class="description"><?= esc(characterLimiter($post->summary, POST_DISPLAY_SUMMARY_LIMIT, '...')); ?></p>
</div>